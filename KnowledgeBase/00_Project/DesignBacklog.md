...
| DES-007 | 暂停、减速和局部时停是否属于首个可玩版本 | Accepted（MVP 延后） | Time、UI、所有玩法模块 | 见 ADR-001、ADR-021；MVP 所有时间倍率固定为 `1`，暂停、减速、加速和局部时停保留为后续扩展 |
...
- `../06_Decisions/ADR-001-TimeSystem.md`：采用自定义时间域；MVP 所有时间倍率固定为 `1`，暂停、减速、加速和局部时停延后，见 ADR-021。
