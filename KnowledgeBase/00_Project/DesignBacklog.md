...
| DES-020 | 玩法碰撞形状、查询方式与敌人阻挡/绕行范围 | Accepted | Army、Bullet、Gate、Prop、Monster、Level | 见 ADR-016、ADR-037；所有玩法碰撞对象使用 Collider2D 与显式 Cast/Overlap，MVP 只实现敌人内部不重叠和排队阻挡，Army/Enemy 允许重合，侧向绕行延后 |
