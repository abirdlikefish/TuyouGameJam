...
> 后续决策：ADR-032 已将 MainMenu、LevelSelect 改为实际 Additive 场景并增加固定 SceneEntry；ADR-051 与 ADR-053 已分别用显式 UI 命令取代 MainMenu、LevelSelect 的 1 秒自动推进。应用状态所有权、单局状态和终局回选关继续有效。
