...
| UI | Gameplay HUD/Result InTest / Input UI ContractReady | `UI/README.md` | HUD 读取只读快照，结果 UI 监听胜负事实并通过 GameStateService 返回、重试或进入下一关 |
...
| Save | InTest（Unity 编译与文件往返通过，目标设备待验收） | `Save/README.md` | IPlayerProgressStore、GameStateService、Application.persistentDataPath |
